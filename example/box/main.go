...
func main() {
	...
	// 	255, 0, 157
	// colorX := phys.Spectrum{X: 227.0 / 255.0, Y: 26.0 / 255.0, Z: 28.0 / 255.0}
	...
	const orbitRadius = 220 * phys.MM // distance in XY plane
	const orbitHeight = 120 * phys.MM // Z height
	const fovHeight = 200 * phys.MM
	const fovWidth = 200 * phys.MM
